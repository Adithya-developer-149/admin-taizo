...
export async function postInterview_schedule(obj) {
  ...
  const response = await fetch(
    `${base_url}/sendInterviewAlert?can_id=${obj.candidateId}&job_id=${
      ...
      obj.Relationship
    }&relationName=${obj.RelationshipName}`,
    requestOptions
  );
  const data = await response.json();
  return data;
...
export async function PutInterviewStatus(
  ...
  const response = await fetch(
    ...
    }notes=${notes}&adminId=${adminId}&statusFlag=true`,
    requestOptions
  );
  const data = await response.json();
  return data;
...
export async function postEmployerLead(leadData) {
  ...
  const response = await fetch(
    `${base_url}/employerLead?admin_id=${parseInt(
      leadData.fromAdminId.val
...
export async function postCandidateLead(leadData) {
  ...
  const response = await fetch(
    `${base_url}/canLead?adminId=${adminID}`,
    requestOptions
  );
  const data = await response.json();
...
export async function PutCandidateLeadCheck(putLead) {
  ...
  let adminID = localStorage.getItem("adminID");
  const response = await fetch(
    `${base_url}/canLeadStatus?canLeadId=${putLead.canLeadId}&adminId=${adminID}&qualified=${putLead.qualified}&notQualified=${putLead.notQualified}&notes=${putLead.notes}`,
    requestOptions
  );
  const data = await response.json();
  return data;
...
export async function PutMIDSENIPORLEVEL(formData) {
  ...
  var raw = JSON.stringify({
    ...
    expInYears: formData.DropdownField1,
    expInMonths: formData.DropdownField2,
